...
class IoTHubPipeline(object):
    def __init__(self, auth_provider, pipeline_configuration):
        ...
        self._pipeline = (
            ...
            #
            # ReconnectStage needs to be before AutoConnectStage because ReconnectStage sets/clears
            ...
            #
            # ConnectionLockStage needs to be before ReconnectStage because we want any ops that
